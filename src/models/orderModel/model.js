...
const GET_ORDER_BY_USER =  `
    select o.id as order_id, o.user_id as user_id, p.product_price, p.product_name, p.id as product_id from orders o LEFT JOIN users u ON u.id=o.id LEFT JOIN products p ON o.product_id=p.id WHERE o.user_id=$1;
`
